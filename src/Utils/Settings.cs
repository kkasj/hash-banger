...
public static class ProblemParameters {
    ...
    public static TaskRanges.TaskRange DEFAULT_RANGE = new TaskRanges.TaskRange(DataIndexer.ToIndex(new string('a', DATA_LENGTH)), DataIndexer.ToIndex(new string('z', DATA_LENGTH)));
    ...
    public static void UpdatePassword(string newPassword) {
        ...
        DEFAULT_RANGE = new TaskRanges.TaskRange(DataIndexer.ToIndex(new string('a', DATA_LENGTH)), DataIndexer.ToIndex(new string('z', DATA_LENGTH)));
    }   
}